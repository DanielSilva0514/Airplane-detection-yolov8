...
Selección de videos con presencia de aviones.

Extracción automática de frames desde los videos.

Filtrado de imágenes útiles.

Etiquetado manual de objetos.

Organización del dataset en formato YOLO.

Entrenamiento del modelo YOLOv8.

Pruebas de inferencia con imágenes nuevas.

Generación de evidencia visual y video de demostración.
...
Requisitos
Instalar las dependencias principales antes de ejecutar el proyecto:
